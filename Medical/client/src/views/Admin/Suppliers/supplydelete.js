...
function SupplierConfimation(props) {
    ...
    const handleListItemClick = async (confirm) => {
        if(confirm === true){
            try {
                await Axios.post(`/deletesupplier/${selectedValue.sup_id}`, ).then((response)=>{
...
export default SupplierConfimation;